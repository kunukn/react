...
function pushHostContextForEventComponent(fiber) {
  var context = requiredContext(contextStackCursor$1.current);
  context !== context &&
    (push(contextFiberStackCursor, fiber), push(contextStackCursor$1, context));
}
...
function updateSuspenseComponent(
  ...
  if (null === current) {
    ...
    else if (((suspenseContext = current.child), nextDidTimeout)) {
...
function updateDehydratedSuspenseComponent(
  ...
  if ('$?' === suspenseInstance.data)
    return (
      ...
      (workInProgress = retryTimedOutBoundary.bind(null, current)),
...
function updateSuspenseListComponent(
  ...
  if (shouldForceFallback)
    ...
    if (
      ...
      current.memoizedState.didSuspend
    )
      a: for (current = nextProps; null !== current; ) {
        if (13 === current.tag) {
          if (null !== current.memoizedState) {
            current.expirationTime < renderExpirationTime &&
              (current.expirationTime = renderExpirationTime);
    ...
    case 'backwards':
      if (!shouldForceFallback) {
        ...
        for (nextProps = null; null !== revealOrder; ) {
          ...
          if (null !== current && !isShowingAnyFallbacks(current)) {
...
function commitUnmount(current$jscomp$0) {
  ...
  switch (current$jscomp$0.tag) {
    ...
    case 1:
      ...
      updateQueue = current$jscomp$0.stateNode;
      if ('function' === typeof updateQueue.componentWillUnmount)
        try {
          startPhaseTimer(current$jscomp$0, 'componentWillUnmount'),
            (updateQueue.props = current$jscomp$0.memoizedProps),
            (updateQueue.state = current$jscomp$0.memoizedState),
            updateQueue.componentWillUnmount(),
            stopPhaseTimer();
        } catch (unmountError) {
          captureCommitPhaseError(current$jscomp$0, unmountError);
        }
      break;
    case 5:
      safelyDetachRef(current$jscomp$0);
      break;
    case 4:
      unmountHostComponents(current$jscomp$0);
      break;
    case 19:
      updateQueue = current$jscomp$0.stateNode;
      ...
      if (null !== effect)
        for (
          ...
          (current = rootEventTypesToEventComponentInstances.get(
            effect[destroy]
          )),
            void 0 !== current && current.delete(updateQueue);
      current$jscomp$0.stateNode = null;
  }
}
          ...
          if (5 === current.tag)
            (updatePayload = current.stateNode),
              newProps
                ...
                : ((updatePayload = current.stateNode),
                  (oldProps = current.memoizedProps.style),
                  (oldProps =
                    void 0 !== oldProps &&
                    null !== oldProps &&
            ...
            current.stateNode.nodeValue = newProps ? '' : current.memoizedProps;
          else if (13 === current.tag && null !== current.memoizedState) {
          ...
          if (
            ...
            do {
              ...
              if (JSCompiler_temp) {
                ...
                attachPingListener(root, renderExpirationTime, value);
              ...
              if (18 === _workInProgress.tag) {
                ...
                if (null === sourceFiber) {
                  sourceFiber = _workInProgress.memoizedState = new PossiblyWeakSet$1();
          ...
          do {
            switch (_workInProgress.tag) {
              case 3:
                ...
                enqueueCapturedUpdate(_workInProgress, renderExpirationTime);
                break a;
              case 1:
                if (
                  ((sourceFiber = value),
    ...
    if (0 === (workInProgress.effectTag & 1024)) {
      a: {
        ...
        switch (current.tag) {
          ...
          case 3:
            ...
            pop(didPerformWorkStackCursor);
            pop(contextStackCursor);
            newProps = current.stateNode;
            newProps.pendingContext &&
              ((newProps.context = newProps.pendingContext),
              (newProps.pendingContext = null));
            if (null === current$jscomp$0 || null === current$jscomp$0.child)
              popHydrationState(current), (current.effectTag &= -3);
          ...
          case 5:
            ...
            renderExpirationTime = current.type;
            if (null !== current$jscomp$0 && null != current.stateNode)
              ...
              if (popHydrationState(current)) {
                ...
                renderExpirationTime = newProps.stateNode;
                rootContainerInstance = newProps.type;
                var props = newProps.memoizedProps;
                renderExpirationTime[internalInstanceKey] = newProps;
                ...
                i = null;
                for (current$jscomp$0 in props)
                  props.hasOwnProperty(current$jscomp$0) &&
                    ((currentHostContext = props[current$jscomp$0]),
                    'children' === current$jscomp$0
                      ? 'string' === typeof currentHostContext
                        ? renderExpirationTime.textContent !==
                            currentHostContext &&
                ...
                switch (rootContainerInstance) {
                  ...
                  case 'textarea':
                    track(renderExpirationTime);
                    postMountWrapper$3(renderExpirationTime);
                    break;
                  case 'select':
                  case 'option':
                    break;
                ...
                null !== current$jscomp$0 && (current.effectTag |= 4);
              } else {
                rootContainerInstance$jscomp$0 = renderExpirationTime;
                current$jscomp$0 = newProps;
                props = current;
                i =
                ...
                currentHostContext === Namespaces.html &&
                  (currentHostContext = getIntrinsicNamespace(
                    rootContainerInstance$jscomp$0
                  ));
                currentHostContext === Namespaces.html
                  ? 'script' === rootContainerInstance$jscomp$0
                    ? ((rootContainerInstance$jscomp$0 = i.createElement(
                        'div'
                      )),
                      (rootContainerInstance$jscomp$0.innerHTML =
                        '<script>\x3c/script>'),
                      (i = rootContainerInstance$jscomp$0.removeChild(
                        rootContainerInstance$jscomp$0.firstChild
                      )))
                    : 'string' === typeof current$jscomp$0.is
                      ? (i = i.createElement(rootContainerInstance$jscomp$0, {
                          is: current$jscomp$0.is,
                        }))
                      : ((i = i.createElement(rootContainerInstance$jscomp$0)),
                        'select' === rootContainerInstance$jscomp$0 &&
                          ((rootContainerInstance$jscomp$0 = i),
                          current$jscomp$0.multiple
                            ? (rootContainerInstance$jscomp$0.multiple = !0)
                            : current$jscomp$0.size &&
                              (rootContainerInstance$jscomp$0.size =
                                current$jscomp$0.size)))
                  : (i = i.createElementNS(
                      currentHostContext,
                      rootContainerInstance$jscomp$0
                ...
                rootContainerInstance$jscomp$0 = i;
                rootContainerInstance$jscomp$0[internalInstanceKey] = props;
                rootContainerInstance$jscomp$0[
                  internalEventHandlersKey
                ] = current$jscomp$0;
                current$jscomp$0 = rootContainerInstance$jscomp$0;
                appendAllChildren(current$jscomp$0, current, !1, !1);
                props = current$jscomp$0;
                var rootContainerInstance$jscomp$1 = rootContainerInstance,
                ...
                switch (renderExpirationTime) {
                  ...
                  case 'link':
                    ...
                    break;
                  case 'form':
                    trapBubbledEvent('reset', props);
                    trapBubbledEvent('submit', props);
                    rootContainerInstance = newProps;
                    break;
                  case 'details':
                    trapBubbledEvent('toggle', props);
                    rootContainerInstance = newProps;
                    break;
                  case 'input':
                    initWrapperState(props, newProps);
                    rootContainerInstance = getHostProps(props, newProps);
                    trapBubbledEvent('invalid', props);
                    ensureListeningTo(
                      rootContainerInstance$jscomp$1,
                      'onChange'
                    );
                    break;
                  case 'option':
                    rootContainerInstance = getHostProps$1(props, newProps);
                    break;
                  case 'select':
                    props._wrapperState = {wasMultiple: !!newProps.multiple};
                    ...
                    break;
                  case 'textarea':
                    initWrapperState$2(props, newProps);
                    rootContainerInstance = getHostProps$3(props, newProps);
                    trapBubbledEvent('invalid', props);
                    ensureListeningTo(
                      rootContainerInstance$jscomp$1,
                      'onChange'
                ...
                assertValidProps(renderExpirationTime, rootContainerInstance);
                rootContainerInstance$jscomp$0 = void 0;
                i = renderExpirationTime;
                currentHostContext = props;
                var nextProps = rootContainerInstance;
                for (rootContainerInstance$jscomp$0 in nextProps)
                  if (
                    nextProps.hasOwnProperty(rootContainerInstance$jscomp$0)
                  ) {
                    var nextProp = nextProps[rootContainerInstance$jscomp$0];
                    'style' === rootContainerInstance$jscomp$0
                      ...
                      : 'dangerouslySetInnerHTML' ===
                        ...
                        : 'children' === rootContainerInstance$jscomp$0
                          ? 'string' === typeof nextProp
                            ? ('textarea' !== i || '' !== nextProp) &&
                          ...
                          : 'suppressContentEditableWarning' !==
                            ...
                            'suppressHydrationWarning' !==
                              rootContainerInstance$jscomp$0 &&
                            'autoFocus' !== rootContainerInstance$jscomp$0 &&
                            (registrationNameModules.hasOwnProperty(
                              rootContainerInstance$jscomp$0
                            )
                              ? null != nextProp &&
                ...
                switch (renderExpirationTime) {
                  case 'input':
                    track(props);
                    postMountWrapper(props, newProps, !1);
                    break;
                  case 'textarea':
                    track(props);
                    postMountWrapper$3(props);
                    break;
                  case 'option':
                    null != newProps.value &&
                      props.setAttribute(
                ...
                shouldAutoFocusHostComponent(renderExpirationTime, newProps) &&
                  (current.effectTag |= 4);
          ...
          case 6:
            if (current$jscomp$0 && null != current.stateNode)
              ...
              popHydrationState(current)
                ? ((newProps = current.stateNode),
                  (current$jscomp$0 = current.memoizedProps),
                  (newProps[internalInstanceKey] = current),
                  newProps.nodeValue !== current$jscomp$0 &&
                    (current.effectTag |= 4))
          ...
          case 13:
            ...
            null === current$jscomp$0
              ? popHydrationState(current)
              : ((rootContainerInstance = current$jscomp$0.memoizedState),
                (renderExpirationTime = null !== rootContainerInstance),
                newProps ||
                  null === rootContainerInstance ||
                  ((rootContainerInstance = current$jscomp$0.child.sibling),
                  null !== rootContainerInstance &&
                    ((props = current.firstEffect),
                    null !== props
                      ? ((current.firstEffect = rootContainerInstance),
                        (rootContainerInstance.nextEffect = props))
                      : ((current.firstEffect = current.lastEffect = rootContainerInstance),
                        (rootContainerInstance.nextEffect = null)),
                    (rootContainerInstance.effectTag = 8))));
            if (newProps && !renderExpirationTime && 0 !== (current.mode & 2))
              if (
                (null === current$jscomp$0 &&
            ...
            if (newProps || renderExpirationTime) current.effectTag |= 4;
            break;
          case 7:
            break;
          case 8:
          ...
          case 18:
            ...
            if (null === current$jscomp$0) {
              if (!popHydrationState(current)) throw ReactErrorProd(Error(318));
              current = current.stateNode;
              if (!current) throw ReactErrorProd(Error(317));
              b: {
                current = current.nextSibling;
                for (newProps = 0; current; ) {
                  if (8 === current.nodeType)
                    if (
                      ((current$jscomp$0 = current.data),
                      '/$' === current$jscomp$0)
                    ) {
                      if (0 === newProps) {
                        nextHydratableInstance = getNextHydratable(
                      ...
                      newProps--;
                    } else '$' === current$jscomp$0 && newProps++;
                  current = current.nextSibling;
                }
                nextHydratableInstance = null;
              }
            } else
              0 === (current.effectTag & 64) &&
                ((current$jscomp$0.alternate = null),
                (current.alternate = null),
                (current.tag = 13),
          ...
          case 21:
            ...
            if (0 === (current.effectTag & 64)) {
              ...
              if (null === newProps || null === newProps.rendering) {
                b: {
                  current$jscomp$0 = current;
                  props = rootContainerInstance = !1;
                  for (
                    rootContainerInstance$jscomp$0 = current.child;
                    null !== rootContainerInstance$jscomp$0;

                  ) {
                    if (13 === rootContainerInstance$jscomp$0.tag) {
                      if (null !== rootContainerInstance$jscomp$0.memoizedState)
                        (rootContainerInstance = !0),
                          null !== rootContainerInstance$jscomp$0.updateQueue &&
                            ((current$jscomp$0.updateQueue =
                              rootContainerInstance$jscomp$0.updateQueue),
                            (current$jscomp$0.effectTag |= 4));
                      else if (
                        ((i = rootContainerInstance$jscomp$0.alternate),
                        null === i || null !== i.memoizedState)
                      )
                        props = !0;
                      if (rootContainerInstance && props) {
                        current$jscomp$0 = !0;
                        break b;
                      }
                    } else if (
                      (21 === rootContainerInstance$jscomp$0.tag &&
                        null !== rootContainerInstance$jscomp$0.updateQueue &&
                        ((current$jscomp$0.updateQueue =
                          rootContainerInstance$jscomp$0.updateQueue),
                        (current$jscomp$0.effectTag |= 4)),
                    ...
                    if (rootContainerInstance$jscomp$0 === current$jscomp$0)
                      break;
                ...
                (current$jscomp$0 = newProps.rendering),
                  newProps.didSuspend ||
                    (now() > newProps.tailExpiration && 1 < renderExpirationTime
                      ? ((newProps.didSuspend = !0),
                        (current.expirationTime = current.childExpirationTime =
                          renderExpirationTime - 1))
                      : (newProps.didSuspend = isShowingAnyFallbacks(
                          current$jscomp$0
                        ))),
                  newProps.isBackwards
                    ? ((current$jscomp$0.sibling = current.child),
                      (current.child = current$jscomp$0))
                    : ((renderExpirationTime = newProps.last),
                      null !== renderExpirationTime
                        ? (renderExpirationTime.sibling = current$jscomp$0)
                        : (current.child = current$jscomp$0),
                      (newProps.last = current$jscomp$0));
              if (null !== newProps && null !== newProps.tail) {
                ...
                current$jscomp$0 = suspenseStackCursor.current;
                current$jscomp$0 = newProps.didSuspend
                  ? (current$jscomp$0 & SubtreeSuspenseContextMask) |
                    ForceSuspenseFallback
                  : current$jscomp$0 & SubtreeSuspenseContextMask;
                push(suspenseStackCursor, current$jscomp$0);
                break a;
              }
            } else current.effectTag &= -65;
            break;
          case 19:
            popHostContext(current);
            current$jscomp$0 = requiredContext(rootInstanceStackCursor.current);
            renderExpirationTime = current.type.responder;
            rootContainerInstance = current.stateNode;
            null === rootContainerInstance
              ? ((rootContainerInstance = null),
                void 0 !== renderExpirationTime.createInitialState &&
                  (rootContainerInstance = renderExpirationTime.createInitialState(
                    newProps
                  )),
                (current.stateNode = createEventComponentInstance(
                  current,
                  newProps,
                  renderExpirationTime,
                  current$jscomp$0,
                ...
                (current.effectTag |= 4))
              : ((rootContainerInstance.props = newProps),
                (rootContainerInstance.currentFiber = current));
            break;
          default:
      ...
      if (
        ...
        for (
          ...
          (renderExpirationTime = current$jscomp$0.expirationTime),
            (rootContainerInstance = current$jscomp$0.childExpirationTime),
        ...
        workInProgress.childExpirationTime = newProps;
      }
...
function commitRootImpl(root) {
  ...
  if (null !== childExpirationTimeBeforeCommit) {
          ...
          if (0 !== (nextEffect.effectTag & 256)) {
            ...
            switch (focusedElem.tag) {
              ...
              case 15:
                ...
                break;
              case 1:
                if (focusedElem.effectTag & 256 && null !== current) {
    ...
    current$jscomp$0 = getActiveElementDeep();
    effectTag = currentRef.focusedElem;
    current = currentRef.selectionRange;
    if (
      current$jscomp$0 !== effectTag &&
      effectTag &&
      ...
      null !== current &&
        ...
        ((current$jscomp$0 = current.start),
        (currentRef = current.end),
        void 0 === currentRef && (currentRef = current$jscomp$0),
        'selectionStart' in effectTag
          ? ((effectTag.selectionStart = current$jscomp$0),
            (effectTag.selectionEnd = Math.min(
              currentRef,
              effectTag.value.length
            )))
          : ((currentRef =
              ((current$jscomp$0 = effectTag.ownerDocument || document) &&
                current$jscomp$0.defaultView) ||
              window),
            currentRef.getSelection &&
              ((currentRef = currentRef.getSelection()),
              (prevProps = effectTag.textContent.length),
              (alternate = Math.min(current.start, prevProps)),
              (current =
                void 0 === current.end
                  ? alternate
                  : Math.min(current.end, prevProps)),
              !currentRef.extend &&
                alternate > current &&
                ((prevProps = current),
                (current = alternate),
              ...
              (prevState = getNodeForCharacterOffset(effectTag, current)),
              prevProps &&
                prevState &&
                ...
                ((current$jscomp$0 = current$jscomp$0.createRange()),
                current$jscomp$0.setStart(prevProps.node, prevProps.offset),
                currentRef.removeAllRanges(),
                alternate > current
                  ? (currentRef.addRange(current$jscomp$0),
                    currentRef.extend(prevState.node, prevState.offset))
                  : (current$jscomp$0.setEnd(prevState.node, prevState.offset),
                    currentRef.addRange(current$jscomp$0))))));
      current$jscomp$0 = [];
      for (currentRef = effectTag; (currentRef = currentRef.parentNode); )
        1 === currentRef.nodeType &&
          current$jscomp$0.push({
            element: currentRef,
            left: currentRef.scrollLeft,
            top: currentRef.scrollTop,
          });
      'function' === typeof effectTag.focus && effectTag.focus();
      for (effectTag = 0; effectTag < current$jscomp$0.length; effectTag++)
        (currentRef = current$jscomp$0[effectTag]),
      ...
      try {
        for (; null !== nextEffect; ) {
          ...
          if (effectTag$jscomp$0 & 36) {
            ...
            childExpirationTimeBeforeCommit = nextEffect;
            switch (childExpirationTimeBeforeCommit.tag) {
              ...
              case 1:
                ...
                if (childExpirationTimeBeforeCommit.effectTag & 4) {
                  if (null === current$jscomp$1)
                    ...
                    var prevProps$jscomp$0 =
                        childExpirationTimeBeforeCommit.elementType ===
                        childExpirationTimeBeforeCommit.type
                ...
                break;
              case 3:
                var _updateQueue = childExpirationTimeBeforeCommit.updateQueue;
                if (null !== _updateQueue) {
                  effectTag = null;
                  if (null !== childExpirationTimeBeforeCommit.child)
                    switch (childExpirationTimeBeforeCommit.child.tag) {
                      case 5:
                        effectTag =
                          childExpirationTimeBeforeCommit.child.stateNode;
                        break;
                      case 1:
                        effectTag =
                          childExpirationTimeBeforeCommit.child.stateNode;
                ...
                break;
              case 5:
                var _instance2 = childExpirationTimeBeforeCommit.stateNode;
                null === current$jscomp$1 &&
                  childExpirationTimeBeforeCommit.effectTag & 4 &&
                  ((effectTag = _instance2),
              ...
              case 19:
                ...
                if (void 0 !== rootEventTypes) {
                  for (
                    childExpirationTimeBeforeCommit = 0;
                    childExpirationTimeBeforeCommit < rootEventTypes.length;
                    childExpirationTimeBeforeCommit++
                  )
                    registerRootEventType(
                      rootEventTypes[childExpirationTimeBeforeCommit],
                      eventComponentInstance
                    );
                  listenToEventResponderEventTypes(
                    rootEventTypes,
  ...
  0 !== effectTag$jscomp$0
    ? ((current$jscomp$1 = requestCurrentTime()),
      (current$jscomp$1 = inferPriorityFromExpirationTime(
        current$jscomp$1,
        effectTag$jscomp$0
      )),
      scheduleCallbackForRoot(root, current$jscomp$1, effectTag$jscomp$0))
    : (legacyErrorBoundariesThatAlreadyFailed = null);
      ...
      switch (workInProgress.tag) {
        ...
        case 21:
          return workInProgress.childExpirationTime < renderExpirationTime
            ? (push(suspenseStackCursor, suspenseStackCursor.current), null)
    ...
    case 10:
      a: {
        ...
        if (null !== getDerivedStateFromProps)
          if (
            ((context = getDerivedStateFromProps.value),
            (hasContext = is(context, hasContext)
              ? 0
              : ('function' ===
                ...
                10 === getDerivedStateFromProps.tag
                  ...
                  : 18 === getDerivedStateFromProps.tag
                    ? (getDerivedStateFromProps.expirationTime <
                        renderExpirationTime &&
                        (getDerivedStateFromProps.expirationTime = renderExpirationTime),
                      (context = getDerivedStateFromProps.alternate),
                      null !== context &&
                    ...
                    : (context = getDerivedStateFromProps.child);
              if (null !== context) context.return = getDerivedStateFromProps;
              else
                for (context = getDerivedStateFromProps; null !== context; ) {
...
var ReactDOMFB = {default: ReactDOM},
